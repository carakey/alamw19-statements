...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- 
        Takes as input the third generation document (F3) of encoded texts in custom XML schema.
        "Randomizes" data: 
        ...
        Creates as output a fourth generation document (F4) of random-ordered encoded texts in custom XML schema.
    -->
